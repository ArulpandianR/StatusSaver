...
public class RecentImageListAdapter extends RecyclerView.Adapter<RecentImageListAdapter.ImageListViewHolder>{
    ...
    private final PublishSubject<Integer> onDeleteStatusClickSubject = PublishSubject.create();
    ...
    public Observable<Integer> getOnStatusDeleteClicks() {
        return onDeleteStatusClickSubject.asObservable();
    }
    ...
    public void onBindViewHolder(final ImageListViewHolder holder, int position) {
        ...
        holder.deleteStatusImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onDeleteStatusClickSubject.onNext(holder.getAdapterPosition());
            }
        });
    ...
    class ImageListViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.delete_status_image_view)
        ImageView deleteStatusImage;
